...
export const ResumeContentConfig: ResumeContentProps = {
  ...
  tldrText: `<div><strong>Years of Experience</strong>: 5</div>`
    + `<div><strong>Programming Languages and Frameworks</strong>:<br/>`
    + `<ul><li>JavaScript, TypeScript, Vue, Nuxt, VitePress, Angular, Node.js, React, and React Native</li><li>C#, ASP.Net, .Net Core, and Xamarin</li><li>CSS, Tailwind CSS, PostCSS, and SCSS</li><li>SQL, PostgreSQL, MySQL, and SQLite</li><li>HTML and XML | Java | Kotlin | MatLab | Python and Flask | C and C++ | R and R Studio</li></ul></div>`
